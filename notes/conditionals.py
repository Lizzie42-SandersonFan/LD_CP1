...
if roll == 20:
    print(f"You rolled a crit! Double you damage.")
    ...
    if roll == 1:
        print(f"You rolled critical failure! The monster gets a free attack!")
        damage = random.randint(1,10) + 2
        player_hp -= damage
        print(f"You took {damage} damage. You know have {player_hp} HP.")
    else:
        print(f"You missed!")
else:
