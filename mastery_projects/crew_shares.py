...
opening = """Hello!
You are a captain on a ship and you and your crew just came back from an adventure looking for treasure.
...
# Get User inputs
treasure_earned = float(input("\nHow much did you and your team find on the adventure(Do NOT include the $ OR ,):\n"))
...
You, the captain, gets ${captains_share:,} of the total ${treasure_money:,}.
